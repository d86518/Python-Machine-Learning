...
#        targettree1 = target0[50:149,]
    ...
    #target=0,2的樹
    if(tr<50):
        featuretree0 = np.vstack((feature0[0:49,],feature0[99:149,]))
        targettree0 = np.hstack((target0[0:49,],target0[99:149,]))
    elif((tr>=100) and (tr<=150)):
        featuretree0 = np.vstack((feature0[0:50,],feature0[100:149,]))
        targettree0 = np.hstack((target0[0:50,],target0[100:149,]))
    else:
        featuretree0 = np.vstack((feature0[0:50,],feature0[100:150,]))
        targettree0 = np.hstack((target0[0:50,],target0[100:150,]))
